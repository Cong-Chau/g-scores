...
Clone dự án, mở Terminal ở vị trí cần lưu trữ dự án

    git clone https://github.com/Cong-Chau/g-scores
...
# 3. Cài đặt và chạy Backend (g-scores-backend)
...
# 4. Chạy Frontend (g-scores-frontend)
